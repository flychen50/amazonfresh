...
class HttpPost extends BetterHttpRequestBase
{
    ...
    HttpPost(AbstractHttpClient abstracthttpclient, String s, HashMap hashmap)
    {
        super(abstracthttpclient);
        request = new org.apache.http.client.methods.HttpPost(s);
    ...
    HttpPost(AbstractHttpClient abstracthttpclient, String s, HttpEntity httpentity, HashMap hashmap)
    {
        super(abstracthttpclient);
        request = new org.apache.http.client.methods.HttpPost(s);
