...
// Referenced classes of package com.github.droidfu.http.ssl:
//            TrivialTrustManager
    ...
    implements SocketFactory, LayeredSocketFactory
{
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            atrustmanager[0] = new TrivialTrustManager();
    ...
    {
        boolean flag;
        if(obj != null && obj.getClass().equals(com/github/droidfu/http/ssl/EasySSLSocketFactory))
            flag = true;
        else
            flag = false;
        return flag;
    ...
    public int hashCode()
    {
        return com/github/droidfu/http/ssl/EasySSLSocketFactory.hashCode();
    }
