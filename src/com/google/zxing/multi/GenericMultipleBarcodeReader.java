...
_L4:
        ...
        if(!flag)
        {
            ...
            if(aresultpoint != null && aresultpoint.length != 0)
            {
                ...
                if(f > 30F)
                    doDecodeMultiple(binarybitmap.crop(0, 0, (int)f, i1), hashtable, vector, 0, 0);
                if(f1 > 30F)
                    doDecodeMultiple(binarybitmap.crop(0, 0, l, (int)f1), hashtable, vector, 0, 0);
                if(f2 < (float)(l - 30))
                    doDecodeMultiple(binarybitmap.crop((int)f2, 0, l, i1), hashtable, vector, (int)f2, 0);
                if(f3 < (float)(i1 - 30))
                    doDecodeMultiple(binarybitmap.crop(0, (int)f3, l, i1), hashtable, vector, 0, (int)f3);
            }
        }
_L2:
        return;
