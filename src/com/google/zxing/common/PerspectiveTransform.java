...
final class PerspectiveTransform
{
    ...
    static PerspectiveTransform quadrilateralToQuadrilateral(float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, 
    ...
    private static PerspectiveTransform quadrilateralToSquare(float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7)
    {
        return squareToQuadrilateral(f, f1, f2, f3, f4, f5, f6, f7).buildAdjoint();
    }

    static PerspectiveTransform squareToQuadrilateral(float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7)
    {
        float f8 = f7 - f5;
