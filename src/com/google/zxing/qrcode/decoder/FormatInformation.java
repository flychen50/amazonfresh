...
final class FormatInformation
{
    ...
    static FormatInformation decodeFormatInformation(int i)
    {
        FormatInformation formatinformation = doDecodeFormatInformation(i);
        FormatInformation formatinformation1;
        if(formatinformation != null)
            formatinformation1 = formatinformation;
        else
            formatinformation1 = doDecodeFormatInformation(i ^ 0x5412);
        return formatinformation1;
    }

    private static FormatInformation doDecodeFormatInformation(int i)
    {
        int j;
        int k;
        int l;
        ...
        l = 0;
_L5:
        if(l >= FORMAT_INFO_DECODE_LOOKUP.length) goto _L2; else goto _L1
_L1:
        int ai[];
        int i1;
        ai = FORMAT_INFO_DECODE_LOOKUP[l];
        i1 = ai[0];
