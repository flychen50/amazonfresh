    ...
    public static AddressBookParsedResult parse(Result result)
    {
        ...
        } else
        {
            ...
            } else
            {
                ...
                String s4 = matchSingleDoCoMoPrefixedField("ADR:", s, true);
                String s5 = matchSingleDoCoMoPrefixedField("BDAY:", s, true);
                if(s5 != null && !isStringOfDigits(s5, 8))
                    s5 = null;
                String s6 = matchSingleDoCoMoPrefixedField("URL:", s, true);
                String s7 = matchSingleDoCoMoPrefixedField("ORG:", s, true);
                addressbookparsedresult = new AddressBookParsedResult(maybeWrap(s1), s2, as1, as2, s3, s4, s7, s5, null, s6);
            }
        }
